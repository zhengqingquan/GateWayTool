...
+--------------+-----------+--------+---------------+--------------------+--------+--------+------+----------+
*/
uint32_t Unpack_ACAN_IC_TCO1(ACAN_IC_TCO1_t* _message, const uint8_t _data[], uint8_t _dlc)
{
	BeforeParse_ACAN_IC_TCO1();

	_message->New_Signal_5 = _data[0] & 0xFFU;
	_message->New_Signal_4 = (_data[1] & 0x0FU) << 3 | (_data[2] & 0xE0U) >> 5;

	_message->monitor.last_cycle = ACAN_GetSystemTick();
	_message->monitor.timeout_cnt = 0;
	_message->monitor.frame_cnt++;
	_message->monitor.dlc_error = (_dlc != IC_TCO1_DLC);

	AfterParse_ACAN_IC_TCO1();

	return IC_TCO1_ID;
}

uint32_t Pack_ACAN_IC_TCO1(ACAN_IC_TCO1_t* _message, uint8_t* _data, uint8_t* _dlc, uint8_t* _ide)
{
...
+--------------+-----------+--------+------------+--------------------+--------+--------+------+----------+
*/
uint32_t Unpack_ACAN_New_Message_5(ACAN_New_Message_5_t* _message, const uint8_t _data[], uint8_t _dlc)
{
	BeforeParse_ACAN_New_Message_5();
	...
	AfterParse_ACAN_New_Message_5();

	return New_Message_5_ID;
}

uint32_t Pack_ACAN_New_Message_5(ACAN_New_Message_5_t* _message, uint8_t* _data, uint8_t* _dlc, uint8_t* _ide)
{
	(void)memset(_data, 0, sizeof(_data));
...
+--------------+-----------+--------+---------------+--------------------+--------+--------+------+----------+
*/
uint32_t Unpack_ACAN_EMS_CCVS(ACAN_EMS_CCVS_t* _message, const uint8_t _data[], uint8_t _dlc)
{
	BeforeParse_ACAN_EMS_CCVS();
	...
	AfterParse_ACAN_EMS_CCVS();

	return EMS_CCVS_ID;
}

uint32_t Pack_ACAN_EMS_CCVS(ACAN_EMS_CCVS_t* _message, uint8_t* _data, uint8_t* _dlc, uint8_t* _ide)
{
	(void)memset(_data, 0, sizeof(_data));
...
+---------------+-----------+--------+------------+--------------------+--------+--------+------+----------+
*/
uint32_t Unpack_ACAN_IC_CCVS1(ACAN_IC_CCVS1_t* _message, const uint8_t _data[], uint8_t _dlc)
{
	BeforeParse_ACAN_IC_CCVS1();
	...
	AfterParse_ACAN_IC_CCVS1();

	return IC_CCVS1_ID;
}

uint32_t Pack_ACAN_IC_CCVS1(ACAN_IC_CCVS1_t* _message, uint8_t* _data, uint8_t* _dlc, uint8_t* _ide)
{
	(void)memset(_data, 0, sizeof(_data));
...
+--------------+-----------+--------+---------------+--------------------+--------+--------+------+----------+
*/
uint32_t Unpack_ACAN_BCM_CCVS(ACAN_BCM_CCVS_t* _message, const uint8_t _data[], uint8_t _dlc)
{
	BeforeParse_ACAN_BCM_CCVS();
	...
	AfterParse_ACAN_BCM_CCVS();

	return BCM_CCVS_ID;
}

uint32_t Pack_ACAN_BCM_CCVS(ACAN_BCM_CCVS_t* _message, uint8_t* _data, uint8_t* _dlc, uint8_t* _ide)
{
	(void)memset(_data, 0, sizeof(_data));
