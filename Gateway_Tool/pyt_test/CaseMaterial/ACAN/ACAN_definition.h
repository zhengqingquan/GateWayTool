...
typedef struct
{
	...
	ACAN_FrameMonitor_t monitor;

}ACAN_IC_TCO1_t;

uint32_t Unpack_ACAN_IC_TCO1(ACAN_IC_TCO1_t* _message, const uint8_t _data[], uint8_t _dlc);
uint32_t Pack_ACAN_IC_TCO1(ACAN_IC_TCO1_t* _message, uint8_t* _data, uint8_t* _len, uint8_t* _ide);
...
}ACAN_New_Message_5_t;

uint32_t Unpack_ACAN_New_Message_5(ACAN_New_Message_5_t* _message, const uint8_t _data[], uint8_t _dlc);
uint32_t Pack_ACAN_New_Message_5(ACAN_New_Message_5_t* _message, uint8_t* _data, uint8_t* _len, uint8_t* _ide);
...
uint32_t Pack_ACAN_EMS_CCVS(ACAN_EMS_CCVS_t* _message, uint8_t* _data, uint8_t* _len, uint8_t* _ide);
...
uint32_t Pack_ACAN_IC_CCVS1(ACAN_IC_CCVS1_t* _message, uint8_t* _data, uint8_t* _len, uint8_t* _ide);
...
uint32_t Pack_ACAN_BCM_CCVS(ACAN_BCM_CCVS_t* _message, uint8_t* _data, uint8_t* _len, uint8_t* _ide);
